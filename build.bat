...
g++ -c .\src\Ui.cpp -o .\build\Ui.o -I W:\SFML\include
...
g++ .\build\main.o .\build\Game.o .\build\GameSounds.o .\build\TetrisShape.o .\build\Ui.o -o .\build\main.exe -L W:\SFML\lib -lsfml-system -lmingw32 -lsfml-graphics -lsfml-window -lsfml-audio -lopengl32 -lwinmm -lgdi32 -DSFML_STATIC
